...
2. **초기 비밀번호 설정 방식:**
   * 관리자 로그인 기본 비밀번호를 `1234` 또는 `admin123`으로 기본 세팅해 둘까요, 아니면 첫 접속 시 직접 설정하게 할까요?
...
> 💡 **Tip:** 본 마크다운 문서는 `portfolio/docs/prd.md` 및 `portfolio/prd.md` 위치에 저장되었으며, 향후 포트폴리오 웹사이트 개발 시 가이드라인으로 활용됩니다.
